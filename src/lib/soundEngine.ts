/**
 * Mario Tours / Bávaro Tours — Web Audio API Synthesizer & Caribbean Sound FX Engine
 * ==================================================================================
...
export function isAudioEnabled(): boolean {
  ...
  const stored = localStorage.getItem('mariotours_audio_fx');
  return stored !== 'false';
}

export function setAudioEnabled(enabled: boolean): void {
  if (typeof window === 'undefined') return;
  localStorage.setItem('mariotours_audio_fx', enabled ? 'true' : 'false');
}
